...
/**
 * Wrapper class Get IP Address of BMC request.
 * 
 * @author Yagnsesh Chawda
 */
public class GetIpAddressCommand
    extends IpmiCommandCoder
{
    private byte[] parameter;

    /**
     * Initiates GetIpAddressCommand for encoding and decoding. Here parameter variable expects byte array of size 4.
     ...
     */
    public GetIpAddressCommand( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
                                byte[] parameter )
    {
    ...
    /**
     * GetCommandCode to return the Custom command Here Get Ip Address is a parameter function of Get LAN Configuration
     */
    @Override
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        GetIpAddressCommandResponseData responseData = new GetIpAddressCommandResponseData();
        ...
        if ( ( parameter != null ) && ( ( parameter[0] & TypeConverter.intToByte( 0x80 ) ) == 0 ) )
        {
            ...
            responseData.setIpAddress( ipAddress );
        }
        return responseData;
    }
}
