...
/**
 * Wrapper class for Chassis Identify Command.
 * 
 * @author Yagnesh Chawda
 */
public class ChassisIdentifyCommand
    extends IpmiCommandCoder
{
    private byte[] parameter;

    /**
     * Initiates ChassisIdentifyCommand for encoding and decoding.
     *
     ...
     */
    public ChassisIdentifyCommand( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
    ...
    {
        return IpmiCommandCodes.CHASSIS_IDENTIFY;
    }
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        return new ChassisIdentifyCommandResponseData();
        /*
         * //Check if the parameter selector is valid if(parameter[0] == 0x05 && raw.length == 7) {
         * GetSystemBootOptionsCommandResponseData responseData = new GetSystemBootOptionsCommandResponseData();
         * responseData.setBootFlagCode(raw); return responseData; } return new
         * GetSystemBootOptionsCommandResponseData();
         */
    }
}
