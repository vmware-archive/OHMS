...
/**
 * Wrapper class for Set System Boot Options.
 * 
 * @author Yagnesh Chawda
 */
public class SetSystemBootOptionsCommand
    extends IpmiCommandCoder
{
    private byte[] parameter;

    /**
     * Initiates SetSystemBootOptionsCommand for encoding and decoding.
     *
     ...
     */
    public SetSystemBootOptionsCommand( IpmiVersion version, CipherSuite cipherSuite,
    ...
    {
        return IpmiCommandCodes.SET_SYSTEM_BOOT_OPTIONS;
    }
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        SetSystemBootOptionsCommandResponseData responseData = new SetSystemBootOptionsCommandResponseData();
        return responseData;
    }
}
