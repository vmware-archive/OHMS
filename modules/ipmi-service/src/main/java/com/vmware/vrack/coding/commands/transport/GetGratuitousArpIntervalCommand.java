...
/**
 * Wrapper class Get Gratuitous ARP Interval of BMC request.
 * 
 * @author Yagnsesh Chawda
 */
public class GetGratuitousArpIntervalCommand
    extends IpmiCommandCoder
{
    private byte[] parameter;

    /**
     * Initiates GetGratuitousArpIntervalCommand for encoding and decoding. Here parameter variable expects byte array
     ...
     */
    public GetGratuitousArpIntervalCommand( IpmiVersion version, CipherSuite cipherSuite,
    ...
    /**
     * GetCommandCode to return the Custom command Here Get Gratuitous Arp Interval is a parameter function of Get LAN
     * Configuration
     */
    @Override
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        GetGratuitousArpIntervalCommandResponseData responseData = new GetGratuitousArpIntervalCommandResponseData();
        ...
        // If parameter[0]'s MS bit is 0 then only it will fetch Get Gratuitous Arp Interval
        if ( ( parameter != null ) && ( ( parameter[0] & TypeConverter.intToByte( 0x80 ) ) == 0 ) )
        {
            responseData.setGratuitousArpIntervalCode( raw[1] );
        }
        return responseData;
    }
}
