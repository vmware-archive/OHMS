...
public class ServiceManager
{
     ...
     * @return true, if successful
     */
    public static boolean setServiceInRunning( final String hmsIbInventoryLocation, final String oobNodesEndpoint )
    {
        ...
        try
        {
            ...
            inventoryLoaded = InventoryUtil.initializeInventory( hmsIbInventoryLocation, oobNodesEndpoint );
