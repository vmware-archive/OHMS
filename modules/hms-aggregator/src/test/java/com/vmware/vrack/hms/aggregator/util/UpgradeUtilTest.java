...
// this.testGetPatchFileVersion("0.0.1-RELEASE", "123456");
// }
//
// /**
...
// String patchFile = String.format("/opt/vrack/upgrade/evorack-hms-bundle-%1$s-%2$s.tar", hmsVersion,
// hmsBuildNumber);
...
// assertTrue(UpgradeUtil.validatePreviousVersion("0.0.1-RELEASE-123456", "0.0.1-RELEASE-123456"));
//
...
//
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-RELEASE-123456", "0.0.1-RELEASE-123457"));
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-RELEASE-123457", "0.0.1-RELEASE-123456"));
//
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-SNAPSHOT-123456", "0.0.1-123456"));
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-RELEASE-123457", "0.0.1-SNAPSHOT-123457"));
//
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-SNAPSHOT", "0.0.1-123456"));
// assertFalse(UpgradeUtil.validatePreviousVersion("0.0.1-RELEASE-123457", "0.0.1-SNAPSHOT"));
//
// }
// }
