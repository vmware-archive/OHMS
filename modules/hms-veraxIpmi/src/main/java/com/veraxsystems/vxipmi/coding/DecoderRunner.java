    ...
    extends Thread
{
    ...
    private static CipherSuite cs =
        new CipherSuite( (byte) 0, SecurityConstants.AA_RAKP_HMAC_SHA1, (byte) 0, (byte) 0 );
        ...
        IllegalArgumentException
    {
        ...
        while ( cssrcv >= 16 )
        {
            ...
            byte[] outmsg = Encoder.encode( new Protocolv20Encoder(),
                                            new GetChannelCipherSuites( TypeConverter.intToByte( 0xE ), index ), 0, 0 );
            ++index;
            DatagramPacket packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        ...
        for ( CipherSuite c : csl )
        {
            try
            {
                logger.info( c.getId() + ": " + c.getAuthenticationAlgorithm().getCode() + " "
                    + c.getIntegrityAlgorithm().getCode() + " " + c.getConfidentialityAlgorithm().getCode() );
            }
            catch ( Exception e )
            {
        ...
        Thread.sleep( 300 );
        byte[] outmsg =
            Encoder.encode( new Protocolv15Encoder(),
                            new GetChannelAuthenticationCapabilities( IpmiVersion.V15, IpmiVersion.V20, cs,
                                                                      PrivilegeLevel.User,
                                                                      TypeConverter.intToByte( 14 ) ),
                            0, 0 );
        DatagramPacket packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        Thread.sleep( 150 );
        outmsg = Encoder.encode( new Protocolv20Encoder(), new OpenSession( 44, PrivilegeLevel.MaximumAvailable, cs ),
                                 0, 0 );
        ...
        lock = true;
        r1 = new Rakp1( managedSeqNum, PrivilegeLevel.User, (String) properties.get( "username" ),
        ...
        outmsg = Encoder.encode( new Protocolv20Encoder(), new Rakp3( (byte) 0, managedSeqNum, cs, r1, r1rd ), 1, 0 );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        Thread.sleep( 150 );
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new GetChassisStatus( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ), 1,
                                 r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        Thread.sleep( 300 );
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new GetSdrRepositoryInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ), 2,
                                 r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        Thread.sleep( 300 );
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new ReserveSdrRepository( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ), 3,
                                 r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        int seq = 4;
        ...
        while ( nextRecId < 65535 )
        {
            ...
            outmsg =
                Encoder.encode( new Protocolv20Encoder(),
                                new GetSdr( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, reservation, nextRecId ),
                                seq++, r1.getManagedSystemSessionId() );
            packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
            dr.socket.send( packet );
            lock = true;
            while ( lock )
            ...
            if ( nextRecId > 0 )
            {
                ...
                outmsg =
                    Encoder.encode( new Protocolv20Encoder(),
                                    new GetSensorReading( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, nextRecId ),
                                    seq++, r1.getManagedSystemSessionId() );
                packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
                dr.socket.send( packet );
                lock = true;
        ...
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new GetSelInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ), seq++,
                                 r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        Thread.sleep( 300 );
        ...
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new ReserveSel( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ), seq++,
                                 r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        lock = true;
        ...
        while ( nextRecId < 65535 )
        {
            ...
            outmsg = Encoder.encode( new Protocolv20Encoder(),
                                     new GetSelEntry( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, reservation,
                                                      nextRecId ),
                                     seq++, r1.getManagedSystemSessionId() );
            packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
            dr.socket.send( packet );
        ...
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new GetFruInventoryAreaInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, fruId ),
                                 seq++, r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
        for ( int i = 0; i < fruSize; i += 100 )
        {
            ...
            outmsg = Encoder.encode( new Protocolv20Encoder(),
                                     new ReadFruData( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, fruId,
                                                      BaseUnit.Bytes, i, cnt ),
                                     seq++, r1.getManagedSystemSessionId() );
            packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
            dr.socket.send( packet );
        }
        Thread.sleep( 300 );
        outmsg = Encoder.encode( new Protocolv20Encoder(),
                                 new CloseSession( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus,
                                                   r1.getManagedSystemSessionId() ),
                                 seq++, r1.getManagedSystemSessionId() );
        packet = new DatagramPacket( outmsg, outmsg.length, ad, 0x26F );
        dr.socket.send( packet );
    ...
    public void run()
    {
        ...
        while ( cssrcv >= 16 )
        {
            ...
            try
            {
                data = (GetChannelCipherSuitesResponseData) Decoder.decode( buffer,
                                                                            new Protocolv20Decoder( CipherSuite.getEmpty() ),
            ...
            if ( data.getCipherSuiteData() != null )
            {
                ...
                System.arraycopy( data.getCipherSuiteData(), 0, temp, cssrec.length, cssrcv );
                cssrec = temp;
            }
            else
            {
        ...
        {
            data =
                (GetChannelAuthenticationCapabilitiesResponseData) Decoder.decode( buffer, new Protocolv15Decoder(),
        ...
        {
            data2 =
                (OpenSessionResponseData) Decoder.decode( buffer, new PlainCommandv20Decoder( CipherSuite.getEmpty() ),
        ...
        {
            data3 =
                (Rakp1ResponseData) Decoder.decode( buffer, new PlainCommandv20Decoder( CipherSuite.getEmpty() ), r1 );
        }
        catch ( IllegalArgumentException e )
        {
            logger.error( e.getMessage(), e );
        ...
        try
        {
            data4 = (Rakp3ResponseData) Decoder.decode( buffer, new PlainCommandv20Decoder( CipherSuite.getEmpty() ),
        ...
        {
            data5 =
                (GetChassisStatusResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
        ...
        {
            data6 =
                (GetSdrRepositoryInfoResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
        ...
        {
            data7 =
                (ReserveSdrRepositoryResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
        ...
        while ( nextRecId < 65535 )
        {
            ...
            try
            {
                data8 = (GetSdrResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
                                                             new GetSdr( IpmiVersion.V20, cs,
            ...
            {
                nextRecId = TypeConverter.byteToInt( ( (CompactSensorRecord) record ).getSensorNumber() );
            }
            else
            {
                nextRecId = -1;
            ...
            if ( record instanceof FullSensorRecord )
            {
                ...
                logger.info( "Lower critical threshold: " + rec.getLowerCriticalThreshold() );
                logger.info( "Upper critical threshold: " + rec.getUpperCriticalThreshold() );
                logger.info( "Tolerance: +/- " + rec.getTolerance() + " " + rec.getSensorBaseUnit().toString()
                    + ( rec.getRateUnit() != RateUnit.None ? " per " + rec.getRateUnit() : "" ) );
                logger.info( "Resolution: " + rec.getSensorResolution() + " " + rec.getSensorBaseUnit().toString()
                    + ( rec.getRateUnit() != RateUnit.None ? " per " + rec.getRateUnit() : "" ) );
            }
            ...
            if ( nextRecId > 0 )
            {
                ...
                try
                {
                    data9 = (GetSensorReadingResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
                    ...
                    {
                        FullSensorRecord rec = (FullSensorRecord) record;
                        logger.info( data9.getSensorReading( rec ) + " " + rec.getSensorBaseUnit().toString()
                            + ( rec.getRateUnit() != RateUnit.None ? " per " + rec.getRateUnit() : "" ) );
                    }
                    if ( record instanceof CompactSensorRecord )
                    {
                        ...
                        List<ReadingType> events =
                            data9.getStatesAsserted( rec.getSensorType(), rec.getEventReadingType() );
                        String s = "";
        ...
        try
        {
            data10 = (GetSelInfoResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
                                                              new GetSelInfo( IpmiVersion.V20, cs,
                                                                              AuthenticationType.RMCPPlus ) );
        }
        catch ( IllegalArgumentException e )
        {
        ...
        try
        {
            data11 = (ReserveSelResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
                                                              new ReserveSel( IpmiVersion.V20, cs,
                                                                              AuthenticationType.RMCPPlus ) );
        }
        catch ( IllegalArgumentException e )
        {
        ...
        while ( nextRecId < 65535 )
        {
            ...
            try
            {
                data12 = (GetSelEntryResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
                                                                   new GetSelEntry( IpmiVersion.V20, cs,
        ...
        {
            data13 =
                (GetFruInventoryAreaInfoResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
        ...
        for ( int i = 0; i < fruSize; i += 100 )
        {
            ...
            try
            {
                data14 = (ReadFruDataResponseData) Decoder.decode( buffer, new Protocolv20Decoder( cs ),
