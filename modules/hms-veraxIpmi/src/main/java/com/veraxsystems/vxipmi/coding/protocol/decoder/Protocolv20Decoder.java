    ...
    extends ProtocolDecoder
{
     ...
     * @see Ipmiv20Message
     * @throws IllegalArgumentException when delivered RMCP message does not contain encapsulated IPMI message or when
     *             AuthCode field is incorrect (integrity check fails).
        ...
        throws IllegalArgumentException, InvalidKeyException
    {
        ...
        if ( message.getAuthenticationType() != AuthenticationType.None
            && !( message.getAuthenticationType() == AuthenticationType.RMCPPlus && !message.isPayloadAuthenticated() )
     ...
     * @throws IndexOutOfBoundsException when message is corrupted and pad length does not appear after integrity pad or
     *             length is incorrect.
     */
        ...
        throws InvalidKeyException
    {
        ...
        return Arrays.equals( authCode, cipherSuite.getIntegrityAlgorithm().generateAuthCode( base ) );
    }
