 ...
 * This command returns the SDR command version for the SDR Repository. It also returns a timestamp for when the last
 * ADD, DELETE, or CLEAR occurred.
 */
    ...
    extends IpmiCommandCoder
{
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        responseData.setReserveSupported( ( TypeConverter.byteToInt( raw[13] ) & 0x2 ) != 0 );
        return responseData;
    }
}
