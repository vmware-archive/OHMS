 ...
 * <br>
 * <p>
 * Send message register via {@link #sendMessage(ConnectionHandle, IpmiCommandCoder)}
 * </p>
 * <br>
 * <p>
...
public class IpmiConnector
{
     ...
     * @throws IOException when properties file was not found
     */
    public IpmiConnector( int port, InetAddress address )
        throws FileNotFoundException, IOException
    {
    ...
    public boolean isSessionValid( ConnectionHandle connectionHandle )
        throws Exception
    {
        return asyncConnector.isSessionValid( connectionHandle );
    }
