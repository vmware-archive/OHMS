    ...
    implements ResponseData
{
    ...
    /**
     * @return True when controller attempted to turn system power on or off, but system did not enter desired state
     */
    ...
    /**
     * @return True when interlock was detected (chassis is presently shut down because a chassis panel interlock switch
     *         is active)
     */
    ...
    /**
     * @return True if last power down caused by a power interlock being activated.
     */
    ...
    /**
     * @return True if Front Panel Lockout active (power off and reset via chassis push-buttons disabled.).
     */
     ...
     * @throws IllegalAccessException when Front Panel Button Capabilities wasn't set.
     */
     ...
     * @throws IllegalAccessException when Front Panel Button Capabilities wasn't set.
     */
    public boolean isResetButtonDisableAllowed()
        throws IllegalAccessException
    {
        if ( !isFrontPanelButtonCapabilitiesSet() )
        {
    ...
    /**
     * @return Power off button disable allowed (in the case there is a single combined power/standby (sleep) button,
     *         disabling power off also disables sleep requests via that button.)
     * @throws IllegalAccessException when Front Panel Button Capabilities wasn't set.
     */
     ...
     * @throws IllegalAccessException when Front Panel Button Capabilities wasn't set.
     */
    public boolean isStandbyButtonDisabled()
        throws IllegalAccessException
    {
        if ( !isFrontPanelButtonCapabilitiesSet() )
        {
    ...
    /**
     * @return Power off button disabled (in the case there is a single combined power/standby (sleep) button, disabling
     *         power off also disables sleep requests via that button are also disabled.)
     * @throws IllegalAccessException when Front Panel Button Capabilities wasn't set.
     */
    public boolean isPowerOffButtonDisabled()
        throws IllegalAccessException
    {
        if ( !isFrontPanelButtonCapabilitiesSet() )
        {
