    ...
    extends IpmiCommandCoder
{
     ...
     * @param sensorId - ID of the sensor which reading is to be retrieved
     */
    public GetSensorReading( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
                             int sensorId )
    {
        ...
        throws NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        return new IpmiLanRequest( getNetworkFunction(), getCommandCode(), payloadData,
