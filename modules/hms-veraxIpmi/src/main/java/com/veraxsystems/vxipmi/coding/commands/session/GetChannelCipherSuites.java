...
/**
 * Wrapper for RMCP+ Get Channel Cipher Suites command. This command can be executed prior to establishing a session
 * with the BMC.
 */
    ...
    extends IpmiCommandCoder
{
    ...
    {
        super( IpmiVersion.V20, new CipherSuite( (byte) 0, (byte) 0, (byte) 0, (byte) 0 ),
     ...
     * @param channelNumber - must be 0h-Bh or Eh-Fh <br>
     *            Eh = retrieve information for channel this request was issued on
     * @param index - (00h-3Fh). 0h selects the first set of 16 cipher suites, 1h selects the next set of 16, and so on
     */
