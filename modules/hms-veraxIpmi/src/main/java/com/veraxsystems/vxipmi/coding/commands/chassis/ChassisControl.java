    ...
    extends IpmiCommandCoder
{
     ...
     * @param powerCommand - {@link PowerCommand} that is to be performed
     */
    public ChassisControl( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
