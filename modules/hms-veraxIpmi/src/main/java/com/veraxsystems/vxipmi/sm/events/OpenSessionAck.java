    ...
    extends Default
{
     ...
     * @param username - ASCII character Name that the user at the Remote Console wishes to assume for this session.
     *            It's length cannot exceed 16.
     * @param password - password matching username
     * @param bmcKey - BMC specific key. Should be null if Get Channel Authentication Capabilities Response indicated
     *            that Kg is disabled which means that 'one-key' logins are being used (
