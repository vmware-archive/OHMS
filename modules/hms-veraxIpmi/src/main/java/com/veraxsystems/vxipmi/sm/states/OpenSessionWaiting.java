 ...
 * <li>Transition to {@link OpenSessionComplete} on {@link DefaultAck}
 * <li>Transition to {@link Authcap} on {@link Timeout}
 */
    ...
    extends State
{
    ...
    public void doAction( StateMachine stateMachine, RmcpMessage message )
    {
        ...
        try
        {
            ...
            /*
             * System.out.println("[OSW " + stateMachine.hashCode() + "] Expected: " + tag + " encountered: " +
