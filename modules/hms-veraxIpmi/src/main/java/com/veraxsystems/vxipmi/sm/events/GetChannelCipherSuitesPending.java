...
/**
 * Performed in {@link CiphersWaiting} {@link State} indcates that not all available {@link CipherSuite}s were received
 * from the remote system and more {@link GetChannelCipherSuites} commands are needed.
 *
 * @see StateMachine
 */
public class GetChannelCipherSuitesPending
    extends Default
{
