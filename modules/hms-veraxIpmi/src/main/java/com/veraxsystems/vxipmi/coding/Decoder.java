...
{
    /**
     * Decodes raw data into {@link ResponseData} - a wrapper class for message-specific response data.
     *
     * @param data - raw RMCP packet to be decoded
     * @param protocolDecoder - instance of {@link IpmiDecoder} class for decoding of the IPMI session header and (if
     *            present) IPMI LAN packet. If IPMI LAN packet is present, {@link Protocolv15Decoder} or
     *            {@link Protocolv20Decoder} should be used (depending on IPMI protocol version used). Otherwise,
     *            {@link PlainCommandv20Decoder} should be used.
     * @param commandCoder - instance of {@link IpmiCommandCoder} class used for wrapping payload into message-dependent
