    ...
    public ProductInfo( byte[] fruData, int offset )
    {
        ...
        while ( partNumber != 0xc1 && offset < fruData.length )
        {
            ...
            if ( partDataLength > 0 && partDataLength + offset < fruData.length )
            {
                ...
                {
                    case 0:
                        setManufacturerName( FruRecord.decodeString( partType, partNumberData,
                                                                     languageCode != 0 && languageCode != 25 ) );
                        break;
                    case 1:
                        setProductName( FruRecord.decodeString( partType, partNumberData,
                                                                languageCode != 0 && languageCode != 25 ) );
                        break;
                    case 2:
                        setProductModelNumber( FruRecord.decodeString( partType, partNumberData,
                                                                       languageCode != 0 && languageCode != 25 ) );
                        break;
                    case 3:
                        setProductVersion( FruRecord.decodeString( partType, partNumberData,
                                                                   languageCode != 0 && languageCode != 25 ) );
                        break;
                    case 4:
                        setProductSerialNumber( FruRecord.decodeString( partType, partNumberData, true ) );
                        break;
                    case 5:
                        setAssetTag( FruRecord.decodeString( partType, partNumberData,
                                                             languageCode != 0 && languageCode != 25 ) );
                        break;
                    case 6:
                    ...
                    default:
                        ...
                        customInfo.add( FruRecord.decodeString( partType, partNumberData,
                                                                languageCode != 0 && languageCode != 25 ) );
                        break;
                }
            }
