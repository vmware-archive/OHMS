...
/**
 * At this state RAKP Message 2 was received - waiting for the confirmation to send RAKP Message 3. Transition to
 * {@link Rakp3Waiting} on {@link Rakp2Ack}.
 */
    ...
    public void doTransition( StateMachine stateMachine, StateMachineEvent machineEvent )
    {
        if ( machineEvent instanceof Rakp2Ack )
        {
            ...
            try
            {
                ...
                stateMachine.sendMessage( Encoder.encode( new Protocolv20Encoder(), rakp3, event.getSequenceNumber(),
                                                          0 ) );
