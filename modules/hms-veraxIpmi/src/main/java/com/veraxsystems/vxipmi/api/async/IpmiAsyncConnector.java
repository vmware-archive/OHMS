    ...
    implements ConnectionListener
{
    ...
    /**
     * Starts {@link IpmiAsyncConnector} and initiates the {@link ConnectionManager} at the given port. The wildcard IP
     ...
     */
    public IpmiAsyncConnector( int port )
        throws IOException
    {
    ...
    /**
     * Starts {@link IpmiAsyncConnector} and initiates the {@link ConnectionManager} at the given port and IP interface.
     *
     * @param port - the port that will be used by {@link IpmiAsyncConnector} to communicate with the remote hosts.
     ...
     * @throws IOException when properties file was not found
     */
    public IpmiAsyncConnector( int port, InetAddress address )
        throws IOException
    {
        listeners = new ArrayList<IpmiListener>();
     ...
     * @throws Exception when sending message to the managed system fails
     */
    public GetChannelAuthenticationCapabilitiesResponseData getChannelAuthenticationCapabilities( ConnectionHandle connectionHandle,
                                                                                                      ...
                                                                                                      throws Exception
    {
        ...
        while ( tries <= retries && result == null )
        {
            ...
            {
                ++tries;
                result = connectionManager.getChannelAuthenticationCapabilities( connectionHandle.getHandle(),
    ...
    public boolean isSessionValid( ConnectionHandle connectionHandle )
        throws Exception
    {
        return connectionManager.getConnection( connectionHandle.getHandle() ).isSessionValid();
    }
     ...
     *
     * @param listener {@link IpmiListener} to notify
     */
     ...
     *
     * @param listener - the {@link IpmiListener} to unregister
     */
