 ...
 * Transition to:
 * <li>{@link Ciphers} on {@link Timeout}
    ...
    extends State
{
    ...
    public void doAction( StateMachine stateMachine, RmcpMessage message )
    {
        ...
        try
        {
            ...
            /*
             * System.out.println("[AW " + stateMachine.hashCode() + "] Expected: " + tag + " encountered: " +
             * TypeConverter.byteToInt(((IpmiLanResponse) ipmiMessage .getPayload()).getSequenceNumber()));
             */
