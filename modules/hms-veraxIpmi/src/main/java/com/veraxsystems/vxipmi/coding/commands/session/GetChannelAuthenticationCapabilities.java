    ...
    extends IpmiCommandCoder
{
    ...
    /**
     * Initiates class for decoding in 1.5 version. Sets requested privilege level to user. Sets channel number to 14
     * indicating that response will contain information for channel this request was issued on. Sets session parameters
     * to default.
     *
    ...
    /**
     * Initiates class. Sets IPMI version to version. Sets requested privilege level to user. Sets channel number to 14
     * indicating that response will contain information for channel this request was issued on.
     *
     * @param version - Version of IPMI protocol used
     * @param requestVersion - If Get Channel Authentication Capabilities command is sent to BMC with requestVersion =
     *            {@link IpmiVersion#V15} it will respond, that it does not support IPMI v2.0 even if it does.
    ...
    /**
     * Initiates class. Sets IPMI version to version. Sets requested privilege level privilegeLevel. Sets channel number
     * to channelNumber.
     *
     * @param version - Version of IPMI protocol used
     * @param requestVersion - If Get Channel Authentication Capabilities command is sent to BMC with requestVersion =
        ...
        throws IllegalArgumentException, IPMIException
    {
        ...
        GetChannelAuthenticationCapabilitiesResponseData responseData =
            new GetChannelAuthenticationCapabilitiesResponseData();
