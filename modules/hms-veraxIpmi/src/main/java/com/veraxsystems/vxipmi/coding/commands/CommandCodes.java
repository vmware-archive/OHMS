...
/**
 * Contains command codes for IPMI commands Byte constants are encoded as pseudo unsigned bytes. IpmiLanConstants
 * doesn't use {@link TypeConverter} because fields need to be runtime constants.
 *
