...
/**
 * Returns response to the unknown command (recognition is up to the higher levels of the architecture) received in the
 * {@link SessionValid} state.
 */
public class MessageAction
    extends StateMachineAction
{
