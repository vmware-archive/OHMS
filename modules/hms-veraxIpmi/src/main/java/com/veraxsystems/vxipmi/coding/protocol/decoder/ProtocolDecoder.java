    ...
    implements IpmiDecoder
{
     ...
     * @param sequenceNumberOffset - Protocol version specific offset to Session Sequence Number field in the header of
     *            the IPMI message.
     * @param payloadLengthOffset - Protocol version specific offset to IPMI Payload Length field in the header of the
     *            IPMI message.
     ...
     */
    @Deprecated
    protected int decode( RmcpMessage rmcpMessage, IpmiMessage message, int sequenceNumberOffset,
                          int payloadLengthOffset, int payloadLengthLength )
