 ...
 * @see OpenSession
 */
public class OpenSessionResponseData
    implements ResponseData
{
    ...
    /**
     * Identifies the status of the previous message. If the previous message generated an error, then only the Status
     * Code, Reserved, and Remote Console Session ID fields are returned.
     */
    ...
    /**
     * The Remote Console Session ID specified by RMCP+ Open Session Request message associated with this response.
     */
    ...
    /**
     * This payload defines the authentication algorithm proposal selected by the Managed System to be used for this
     * session
     */
    private byte authenticationAlgorithm;

    /**
     * This payload defines the integrity algorithm proposal selected by the Managed System to be used for this session
     */
    private byte integrityAlgorithm;

    /**
     * This payload defines the confidentiality algorithm proposal selected by the Managed System to be used for this
     * session
     */
