    ...
    implements Messenger
{
    ...
    /**
     * Size of the message data buffer. Default {@link UdpMessenger#DEFAULTBUFFERSIZE}.
     */
     ...
     * @throws SocketException if the socket could not be opened, or the socket could not bind to the specified local
     *             port.
     ...
     *             port.
     */
    public UdpMessenger( int port, InetAddress address )
    ...
    /**
     * Returns number of packets sent since last creation of the instance of {@link UdpMessenger}. For debug/testing
     * purposes only.
     */
     ...
     */
    public synchronized void send( UdpMessage message )
        throws IOException
    {
