    ...
    extends IpmiCommandCoder
{
     ...
     */
    public ReserveSel( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType )
    {
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        {
            throw new IllegalArgumentException( "This is not a response for Reserve SEL command" );
        }
        ...
        buffer[2] = 0;
        buffer[3] = 0;
        responseData.setReservationId( TypeConverter.littleEndianByteArrayToInt( buffer ) );
        return responseData;
    }
}
