    ...
    implements UdpListener
{
     ...
     *
     * @param messenger - {@link Messenger} connected to the {@link Constants#IPMI_PORT}
     */
    ...
    /**
     * @return true if {@link StateMachine} is at the point when it acquires session and will send sessionless messages
     */
