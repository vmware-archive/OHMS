...
public interface ConnectionListener
{
     ...
     *            timed out or an error occured during decoding.
     * @param handle - the id of the connection that received the message
     * @param id - tag of the request-response pair
     * @param exception - null if everything went correctly or timeout occured, contains exception that occured during
     *            decoding if it failed.
     */
