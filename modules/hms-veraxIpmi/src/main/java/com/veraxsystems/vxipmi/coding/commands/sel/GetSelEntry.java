    ...
    extends IpmiCommandCoder
{
     ...
     * @param reservationId - SEL reservation ID received via {@link ReserveSel} command or 0 if requesting for whole
     *            record
     * @param recordId - ID of the record to get
     */
    public GetSelEntry( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
