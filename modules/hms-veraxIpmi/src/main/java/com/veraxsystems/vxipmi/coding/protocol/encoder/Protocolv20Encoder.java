    ...
    extends ProtocolEncoder
{
        ...
        throws IllegalArgumentException, InvalidKeyException
    {
        ...
        int offset = 1;
        raw[offset] = encodePayloadType( message.isPayloadEncrypted(), message.isPayloadAuthenticated(),
    ...
    {
        int length =
            12 + ipmiMessage.getConfidentialityAlgorithm().getConfidentialityOverheadSize( ipmiMessage.getPayloadLength() )
