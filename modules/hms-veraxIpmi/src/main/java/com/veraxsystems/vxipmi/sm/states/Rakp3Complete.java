...
/**
 * Empty state inserted to keep the convention of Waiting-Complete states. At this point Session Challenge is over and
 * {@link StateMachine} can transit to {@link SessionValid} on {@link DefaultAck}
 */
public class Rakp3Complete
    extends State
{
    @Override
