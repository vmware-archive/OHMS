...
public abstract class FruRecord
{
     ...
     *
     * @param typeFormat - 00 - binary or unspecified 01 - BCD plus (see below) 10 - 6-bit ASCII, packed (overrides
     *            Language Codes) 11 - Interpretation depends on Language Codes. 11b indicates 8-bit ASCII + Latin 1 if
     *            the Language Code is English for the area or record containing the field, or 2-byte UNICODE (least
     *            significant byte first) if the Language Code is not English.
     * @param data - encoded data
     * @param isEnglishLanguageCode - true if the Language Code is English
