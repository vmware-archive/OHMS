    ...
    extends IpmiCommandCoder
{
    ...
    /**
     * The Managed System's Session ID for this session. Must be as returned by the Managed System in the Open Session
     * Response message.
     */
     ...
     *            this session. Only authentication algorithm is used at this point of creating a session.
     * @param rakp1 - RAKP Message 1 sent earlier in the authentification process
    ...
    public Rakp3( CipherSuite cipherSuite, Rakp1 rakp1, Rakp1ResponseData rakp1ResponseData )
    {
        ...
        setCipherSuite( new CipherSuite( (byte) 0, cipherSuite.getAuthenticationAlgorithm().getCode(), (byte) 0,
                                         (byte) 0 ) );
    }
        ...
        throws NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        message.setAuthCode( getCipherSuite().getIntegrityAlgorithm().generateAuthCode( message.getIntegrityAlgorithmBase( new Protocolv20Encoder() ) ) );
        return message;
    }
        ...
        throws NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        System.arraycopy( manSesId, 0, payload, 4, 4 ); // managed system session
                                                        // id
        byte[] exchangeAuthCode =
            getCipherSuite().getAuthenticationAlgorithm().getKeyExchangeAuthenticationCode( prepareKeyExchangeAuthenticationCodeBase( rakp1,
                                                                                                                                      rakp1ResponseData ),
                                                                                            rakp1.getPassword() );
        byte[] result = null;
    ...
    private byte[] prepareKeyExchangeAuthenticationCodeBase( Rakp1 rakp1, Rakp1ResponseData responseData )
    {
        ...
        System.arraycopy( TypeConverter.intToLittleEndianByteArray( responseData.getRemoteConsoleSessionId() ), 0, keac,
                          16, 4 );
        ...
        throws IllegalArgumentException, IPMIException, InvalidKeyException, NoSuchAlgorithmException
    {
        ...
        /*
         * Skip Integrity check if (!getCipherSuite().getAuthenticationAlgorithm().doIntegrityCheck(
         * prepareIntegrityCheckBase(rakp1, rakp1ResponseData), integrityCheck, rakp1.calculateSik(rakp1ResponseData)))
    ...
    private byte[] prepareIntegrityCheckBase( Rakp1 rakp1, Rakp1ResponseData responseData )
    {
        ...
        System.arraycopy( TypeConverter.intToLittleEndianByteArray( rakp1.getManagedSystemSessionId() ), 0, icb, 16,
                          4 );
