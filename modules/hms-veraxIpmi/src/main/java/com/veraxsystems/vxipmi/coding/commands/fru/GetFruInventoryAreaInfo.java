    ...
    extends IpmiCommandCoder
{
     ...
     * @param fruId - ID of the FRU to get info from. Must be less than 256.
     */
    public GetFruInventoryAreaInfo( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
                                    int fruId )
    {
        ...
        throws IllegalArgumentException, IPMIException, NoSuchAlgorithmException, InvalidKeyException
    {
        ...
        responseData.setFruUnit( BaseUnit.parseInt( TypeConverter.byteToInt( raw[2] ) & 0x1 ) );
        return responseData;
    }
}
