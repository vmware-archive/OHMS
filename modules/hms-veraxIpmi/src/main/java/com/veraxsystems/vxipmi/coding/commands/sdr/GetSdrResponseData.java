 ...
 */
public class GetSdrResponseData
    implements ResponseData
{
    ...
    /**
     * @return Unparsed sensor record data. Might contain only part of the record, depending on offset and size
     *         specified in the request. To parse data use {@link SensorRecord#populateSensorRecord(byte[])}.
     */
