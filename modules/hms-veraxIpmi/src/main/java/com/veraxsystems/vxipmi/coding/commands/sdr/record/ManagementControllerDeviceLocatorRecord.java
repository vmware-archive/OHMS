 ...
 */
public class ManagementControllerDeviceLocatorRecord
    extends SensorRecord
{
    ...
    /**
     * For BMC, indicates BMC provides interface to SDR Repository. For other controller, indicates controller accepts
     * Device SDR commands
     */
