...
public abstract class IpmiResponse
{
    ...
    /**
     * {@link ConnectionHandle} to the message that was an origin of the response Handle contains only the id of the
     * connection, not the {@link CipherSuite} and {@link PrivilegeLevel} used in that connection.
     */
