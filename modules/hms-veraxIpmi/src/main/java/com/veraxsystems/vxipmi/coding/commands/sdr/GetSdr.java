    ...
    extends IpmiCommandCoder
{
    ...
    /**
     * Initiates GetSdr for both encoding and decoding. 'Offset info record' and 'bytes to read' fields are set to read
     * whole record.
     *
     ...
     * @param reservationId - SDR reservation ID received via {@link ReserveSdrRepository} command
     * @param recordId - ID of the record to get
     */
    public GetSdr( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
                   int reservationId, int recordId )
    {
        this( version, cipherSuite, authenticationType, reservationId, recordId, 0, 0xFF );
    }
     ...
     * @param reservationId - SDR reservation ID received via {@link ReserveSdrRepository} command
     * @param recordId - ID of the record to get
     * @param offset - the offset into record, at which reading should be started
     * @param bytesToRead - number of bytes to read
     */
    public GetSdr( IpmiVersion version, CipherSuite cipherSuite, AuthenticationType authenticationType,
                   int reservationId, int recordId, int offset, int bytesToRead )
    {
