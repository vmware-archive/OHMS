...
/**
 * This record is the same as the {@link EntityAssociationRecord}, except that it supports describing associations
 * between entities that have device-relative Entity Instance values as well as system-relative values.
 */
public class DeviceRelativeEntityAssiciationRecord
