    ...
    implements MachineObserver
{
        ...
        throws Exception
    {
        super.tearDown();
        if ( sik != null )
            machine.sendMessage( Encoder.encode( new Protocolv20Encoder(),
                                                 new CloseSession( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus,
                                                                   managedSystemSessionId ),
                                                 getSequenceNumber(), managedSystemSessionId ) );
        machine.stop();
     ...
     */
    @Test
    public void testSmCiphers()
        throws UnknownHostException, NoSuchAlgorithmException
    {
        logger.info( "Testing Ciphers" );
        doSetUp( InetAddress.getByName( properties.getProperty( "testIp" ) ) );
        doGetCipherSuites( new CipherSuite( (byte) 2, new AuthenticationRakpHmacSha1().getCode(),
     ...
     */
    @Test
    public void testAuthCapTimeout()
        throws UnknownHostException, NoSuchAlgorithmException
    {
     ...
     */
    @Test
    public void testOpenSessionTimeout()
        throws UnknownHostException, NoSuchAlgorithmException
    {
     ...
     */
    @Test
    public void testSendInSessionMessage()
        throws UnknownHostException, NoSuchAlgorithmException
    {
        logger.info( "Testing sending in-session message" );
        testStartSession();
        rcv = 0;
        machine.doTransition( new Sendv20Message( new ReserveSdrRepository( IpmiVersion.V20, cs,
        ...
        throws UnknownHostException, NoSuchAlgorithmException
    {
        ...
        testStartSession();
        machine.doTransition( new com.veraxsystems.vxipmi.sm.events.CloseSession( managedSystemSessionId,
                                                                                  getSequenceNumber() ) );
        assertEquals( Authcap.class, machine.getCurrent().getClass() );
    }
        ...
        throws UnknownHostException, NoSuchAlgorithmException
    {
        ...
        doSetUp( InetAddress.getByName( properties.getProperty( "testIp" ) ) );
        doGetCipherSuites( new CipherSuite( (byte) 3, new AuthenticationRakpHmacSha1().getCode(),
    ...
    public void notify( StateMachineAction action )
    {
        ...
        else if ( action instanceof ErrorAction )
        {
            ...
            fail( e.getMessage() + " " + ( e instanceof IPMIException ? ( (IPMIException) e ).getMessage() + " " : "" )
                + "Machine state: " + machine.getCurrent().getClass().getSimpleName() );
        }
    ...
    private void doSetUp( InetAddress address )
        throws UnknownHostException
    {
        responseData = null;
        try
    ...
    private void doGetCipherSuites( CipherSuite cipherSuite )
    {
        ...
        cs = cipherSuite;
        /*
         * cs = new CipherSuite((byte) 2, new AuthenticationRakpHmacSha1().getCode(), new
         * ConfidentialityNone().getCode(), new IntegrityHmacSha1_96().getCode());
         */
    ...
    private void doGetAuthCap()
    {
        ...
        if ( responseData == null || !( responseData instanceof GetChannelAuthenticationCapabilitiesResponseData ) )
            fail();
    ...
    private void doOpenSession()
    {
        ...
        if ( responseData == null || !( responseData instanceof OpenSessionResponseData ) )
            fail();
        ...
        machine.doTransition( new OpenSessionAck( cs, PrivilegeLevel.User, getSequenceNumber(), managedSystemSessionId,
    ...
    private void doRakp1()
    {
        ...
        if ( responseData == null || !( responseData instanceof Rakp1ResponseData ) )
            fail();
    ...
    private void doRakp3()
    {
        ...
        if ( responseData == null || !( responseData instanceof Rakp3ResponseData ) )
            fail();
        machine.doTransition( new DefaultAck() );
    ...
    /**
     * The sequence number generated by the {@link StateMachine} to keep BMC happy when re-sending a message. Differs
     * from sequence number given with the message to pair message and response. Sequence number is auto-incremented.
     * Should be used only for encoding messages.
     */
