    ...
    implements IpmiListener
{
        ...
        throws Exception
    {
        ...
        handle = connector.createConnection( InetAddress.getByName( properties.getProperty( "testIp" ) ) );
    }
    ...
    /**
     * Tests {@link IpmiAsyncConnector#getAvailableCipherSuites(ConnectionHandle)}
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests {@link IpmiAsyncConnector#openSession(ConnectionHandle, String, String, byte[])}
     *
     * @throws Exception
     */
    @Test
        ...
        throws Exception
    {
        ...
        connector.openSession( handle, properties.getProperty( "username" ), properties.getProperty( "password" ),
                               null );
    }
        ...
        throws Exception
    {
        ...
        testOpenSession();
        connector.sendMessage( handle, new GetChassisStatus( IpmiVersion.V20, handle.getCipherSuite(),
