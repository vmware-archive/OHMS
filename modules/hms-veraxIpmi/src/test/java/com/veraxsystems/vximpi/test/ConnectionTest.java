    ...
    extends TestCase
{
     ...
     * {@link Connection#getChannelAuthenticationCapabilities(int, CipherSuite, PrivilegeLevel)} and
        ...
        throws FileNotFoundException, IOException
    {
        ...
        try
        {
            connection.connect( InetAddress.getByName( properties.getProperty( "testIp" ) ), 30000 );
        }
        ...
        try
        {
            ...
            connection.getChannelAuthenticationCapabilities( 0, cs, PrivilegeLevel.User );
            connection.startSession( 0, cs, PrivilegeLevel.User, properties.getProperty( "username" ),
    ...
    /**
     * Tests {@link Connection#sendIpmiCommand(com.veraxsystems.vxipmi.coding.commands.IpmiCommandCoder)}
     *
    ...
    public void testSendMessage()
        throws ConnectionException, InterruptedException, FileNotFoundException, IOException
    {
        logger.info( "Testing Send Message" );
        testSessionChallenge();
        try
        {
            connection.sendIpmiCommand( new ReserveSel( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
            // Thread.sleep(100);
        }
        catch ( Exception e )
        {
     ...
     */
    @Test
    public void testConnectionKeepup()
     ...
     */
    @Test
    public void testParallelSessions()
        throws UnknownHostException, InterruptedException
    {
        ...
        for ( int j = 0; j < 3; ++j )
        {
            ...
            {
                SessionRunner sr =
                    new SessionRunner( InetAddress.getByName( properties.getProperty( "testIp" ) ), messenger );
                sr.start();
            }
            Thread.sleep( 3000 );
        }
