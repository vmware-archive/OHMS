    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        int index = connectionManager.createConnection( InetAddress.getByName( properties.getProperty( "testIp" ) ) );
        List<CipherSuite> cipherSuites = connectionManager.getAvailableCipherSuites( index );
        assertTrue( cipherSuites.size() > 3 );
        cs = cipherSuites.get( 3 );
        connectionManager.getChannelAuthenticationCapabilities( index, cs, PrivilegeLevel.User );
        connectionManager.startSession( index, cs, PrivilegeLevel.User, properties.getProperty( "username" ),
     ...
     */
    @Test
    public void testGetChassisStatus()
        throws Exception
    {
        logger.info( "Testing Get Chassis Status" );
        sendCommand( new GetChassisStatus( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
    }
     ...
     */
    @Test
    public void testGetFruInventoryArea()
        throws Exception
    {
        logger.info( "Testing Get Fru Inventory Area" );
        sendCommand( new GetFruInventoryAreaInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, 0 ) );
    }
        ...
        throws Exception
    {
        ...
        for ( int i = 0; i < responseData.getFruInventoryAreaSize(); i += size )
        {
            ...
            sendCommand( new ReadFruData( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, 0, BaseUnit.Bytes, i,
                                          size ) );
     ...
     */
    @Test
    public void testGetSdrRepositoryInfo()
        throws Exception
    {
        logger.info( "Testing Get Sdr Repository Info" );
        sendCommand( new GetSdrRepositoryInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
    }
     ...
     */
    @Test
    public void testReserveSdrRepository()
        throws Exception
    {
        logger.info( "Testing Reserve Sdr Repository" );
        sendCommand( new ReserveSdrRepository( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
    }
     ...
     */
    @Test
    public void testGetSdr()
        throws Exception
    {
        logger.info( "Testing Get Sdr" );
        sendCommand( new ReserveSdrRepository( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
        int id = ( (ReserveSdrRepositoryResponseData) listener.responseData ).getReservationId();
        sendCommand( new GetSdr( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, id, 0 ) );
    }
        ...
        throws Exception
    {
        ...
        sendCommand( new ReserveSdrRepository( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
        int id = ( (ReserveSdrRepositoryResponseData) listener.responseData ).getReservationId();
        sendCommand( new GetSdr( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, id, 1 ) );
        sendCommand( new GetSensorReading( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, 1 ) );
    }
        ...
        throws Exception
    {
        ...
        sendCommand( new GetSelInfo( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
    }
     ...
     */
    @Test
    public void testReserveSel()
        throws Exception
    {
        logger.info( "Testing Reserve Sel" );
        sendCommand( new ReserveSel( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
    }
     ...
     */
    @Test
    public void testGetSelEntry()
        throws Exception
    {
        logger.info( "Testing Get Sel Entry" );
        sendCommand( new ReserveSel( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus ) );
        int id = ( (ReserveSelResponseData) listener.responseData ).getReservationId();
        sendCommand( new GetSelEntry( IpmiVersion.V20, cs, AuthenticationType.RMCPPlus, id, 1 ) );
    }
        ...
        throws ArithmeticException, ConnectionException, InterruptedException
    {
        ...
        logger.info( "Received answer for " + coder.getClass().getSimpleName() );
    }
