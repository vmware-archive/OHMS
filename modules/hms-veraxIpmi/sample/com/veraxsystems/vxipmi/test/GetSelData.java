...
ConnectionHandle handle = connector.createConnection(InetAddress.getByName("10.28.197.208"));
...
connector.openSession(handle, "root", "root123", null);
...
GetSelInfoResponseData selInfoResponseData = (GetSelInfoResponseData) connector.sendMessage(handle,
new GetSelInfo(IpmiVersion.V20, cs, AuthenticationType.RMCPPlus));

System.out.println(selInfoResponseData.getEntriesCount());
System.out.println(selInfoResponseData.getSelVersion());
System.out.println(selInfoResponseData.getAdditionTimestamp());
System.out.println(selInfoResponseData.getEraseTimestamp());
