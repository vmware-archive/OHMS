...
public class BoardService_S210
    implements IBoardService
{
    ...
    private static Logger logger = Logger.getLogger( BoardService_S210.class );

    IpmiService ipmiServiceExecutor = new IpmiServiceExecutor();

    public BoardService_S210()
    {
        super();
    ...
    private void init()
    {
        ...
        setFruReadPacketSize( 20 );
    }

    public BoardService_S210( List<BoardInfo> supportedBoards )
    {
