 ...
 *
 */
public interface ISwitchService extends IComponentSwitchEventInfoProvider {
    /**
     ...
     * @return
     */
    boolean updateSwitchIpAddress(SwitchNode switchNode, String ipAddress, String netmask, String gateway) throws HmsException;
     ...
     */
    boolean updateSwitchTimeServer(SwitchNode switchNode, String timeServer) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean setSwitchPortStatus(SwitchNode switchNode, String portName, PortStatus portStatus) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean updateSwitchPort(SwitchNode switchNode, String portName, SwitchPort portInfo) throws HmsException;
     ...
     * @throws HmsException
     */
    SwitchVlan getSwitchVlan(SwitchNode switchNode, String vlanName) throws HmsException;
     ...
     * @return true if successful, false if not
     */
    boolean createVlan(SwitchNode switchNode, SwitchVlan vlan) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean updateVlan(SwitchNode switchNode, String vlanName, SwitchVlan vlan) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean deleteVlan(SwitchNode switchNode, String vlanName) throws HmsException;
     ...
     * @throws HmsException
     */
    SwitchLacpGroup getSwitchLacpGroup(SwitchNode switchNode, String lacpGroupName) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean createLacpGroup(SwitchNode switchNode, SwitchLacpGroup lacpGroup) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean deleteLacpGroup(SwitchNode switchNode, String lacpGroupName) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean reboot(SwitchNode switchNode) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean upgrade(SwitchNode switchNode, SwitchUpgradeInfo upgradeInfo) throws HmsException;
     ...
     */
    @Deprecated
    boolean applyNetworkConfiguration(SwitchNode switchNode, SwitchNetworkConfiguration networkConfiguration) throws HmsException;
     ...
     * @return true if successful, false if not
     */
    boolean createVxlan(SwitchNode switchNode, SwitchVxlan vxlan) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean deleteVxlan(SwitchNode switchNode, String vxlanName, String vlanName) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean configureOspf(SwitchNode switchNode, SwitchOspfConfig ospf) throws HmsException;
     ...
     * @return
     */
    SwitchOspfConfig getOspf(SwitchNode switchNode) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean configureBgp(SwitchNode switchNode, SwitchBgpConfig bgp) throws HmsException;
     ...
     * @throws HmsException
     */
    SwitchSensorInfo getSwitchSensorInfo(SwitchNode switchNode) throws HmsException;
     ...
     * @throws HmsException
     */
    boolean configureMclag(SwitchNode switchNode, SwitchMclagInfo mclag) throws HmsException;
    ...
    /**
     * Sets (overwrites) the values specified in the bulk configuration on the
     * switch in the specified/all configurable places
     *
     * @param switchNode
     * @param configs
