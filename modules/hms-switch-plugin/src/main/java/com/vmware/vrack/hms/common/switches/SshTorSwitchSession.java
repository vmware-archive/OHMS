...
public class SshTorSwitchSession implements SwitchSession {
	...
	@Override
	public synchronized void connect() throws HmsException {
		connect(DEFAULT_CONNECTION_TIMEOUT);
	}

	@Override
	public synchronized void connect(int timeout) throws HmsException {
        ...
        try {
        	...
        	logger.error ("Received exception connecting to switch " + switchNode.getSwitchId() + " at " + protocol + "://" + ipAddress + ":" + port, je);
        	disconnect();
        }
	}
	...
	@Override
	public synchronized String execute(String command) throws HmsException {
	...
	public synchronized void executeNoResponse(String command) throws HmsException {
		try {
	...
	public synchronized String execute(	String[] commands) throws HmsException {
		String trimmedResult = null;
	...
	public synchronized SshExecResult executeEnhanced(String command) throws HmsException {
		SshExecResult result = SshUtil.executeCommandEnhanced(sshSession, command);
		return result;
	}
	
	@Override
	public synchronized boolean upload(InputStream localInputStream, String remoteFilename) throws HmsException {
	...
	@Override
	public synchronized boolean download(OutputStream localOutputStream, String remoteFilename) throws HmsException {
		boolean success = false;
