...
/**
 * Provides basic implementation for the object Bond. Extends Switch Port implementation.
 *
 * Created by sankala on 12/5/14.
 */
public class Bond extends SwitchPort {
    /** Set of variables used for create the object bond */
    public List<SwitchPort> slaves = new ArrayList<>();

    static Pattern bondPattern = Pattern.compile("\\s*(bond-slaves|bridge-vlan-aware|bridge-ports|bridge-vids|bridge-pvid|bridge-access|mtu|bond-lacp-bypass-allow|address) (.*)$");
    ...
    /**
     * To verify if any of the slave ports are matching with a specific port
     * name or not
     * 
     * @param name
     * @return
