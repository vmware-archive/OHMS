...
/**
 * Provides functionality on the cumulus ports configuration. This class provides functionality on the ports
 * configuration such as get port speed and reload.
 */
public class CumulusPortsConf
{

    /**
     * Get the cumulus port configuration instance. Using the switch node, return the cumulus port configuration object.
     * 
    ...
    /**
     * Used to reload the switch session object Using the switch session object, get the ports configuration properties
     * from the file - and set the properties.
     * 
     * @param torSwitchSession - switch session object
     */
    ...
    /**
     * Get the port speed From the Properties object created from the properties file, get the port speed.
     * 
