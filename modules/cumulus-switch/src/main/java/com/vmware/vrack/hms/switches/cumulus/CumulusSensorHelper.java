...
/**
 * Provides functionality for sensor apis. This class provides functionality on sensor information such as get Sensor
 * Info and get component sensor list.
 */
public class CumulusSensorHelper
{

    /**
     * Constructor for class CumulusSensorHelper Cumulus Sensor helper class constructor; sets the service for the
     * CumulusSensorHelper object.
     * 
    ...
    /**
     * Gets the switch sensor info from the switch node Using the switch session, get a list of all sensor items.
        ...
        throws HmsException
    {
        ...
        try
        {
            ...
            List<Map> sensorList =
                JsonUtils.getBeanCollectionFromJsonString( new String( result.getStdout() ), Map.class );
            @SuppressWarnings( "rawtypes" )
            ...
            while ( it.hasNext() )
            {
                ...
                switch ( type )
                {
                    case "temp":
                        ...
                        chassisTemp.setStatus( "OK".equals( sensorItem.get( "state" ) ) ? HmsSensorState.Ok
                                        : HmsSensorState.Invalid );
                    ...
                    case "power":
                        ...
                        psuStatus.setStatus( "OK".equals( sensorItem.get( "state" ) ) ? HmsSensorState.Ok
                                        : HmsSensorState.Invalid );
                    ...
                    case "fan":
                        ...
                        fanSpeed.setStatus( "OK".equals( sensorItem.get( "state" ) ) ? HmsSensorState.Ok
                                        : HmsSensorState.Invalid );
    ...
    /**
     * Get the entire sensor list (component sensor list) Using the service node (chassis, fanspeed, psu status), get
     * the list of those sensors. Converts all types into list of Server Component Sensor type
     * 
     * @param serviceNode service node corresponding to a switch node instance
     * @param component server component
     * @return List of ServerComponentEvents. This includes all list of components for the Switch: Fan Speeds, Chassis
     *         Temps, and Psu Status
