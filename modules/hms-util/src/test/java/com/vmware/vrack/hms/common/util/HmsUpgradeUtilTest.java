...
public class HmsUpgradeUtilTest
{
    ...
    /** The user home. */
    private String upgradeDir = null;
    ...
    public HmsUpgradeUtilTest()
    {
        ...
        upgradeDir = FilenameUtils.concat( System.getProperty( "java.io.tmpdir" ), timeInMillis );
    }
    ...
    public void testSaveUpgradeStatus()
    {
        ...
        upgradeStatusFileName = upgradeDir + File.separator + timeInMillis + ".json";
        ...
        File upgradeDirFile = new File( upgradeDir );
        if ( upgradeDirFile.exists() && upgradeDirFile.isDirectory() )
        {
            upgradeDirFile.delete();
        }
    }
