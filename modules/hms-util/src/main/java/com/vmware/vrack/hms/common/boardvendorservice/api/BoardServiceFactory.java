...
public class BoardServiceFactory
{
    ...
    public static final String BOARD_SERVICE_BASE_PACKAGES_PROP = "BOARD_SERVICE_BASE_PACKAGES";
     ...
     */
    public static BoardServiceFactory getBoardServiceFactory()
    {
    ...
    public static void initialize()
    {
        ...
        /*
         * boardServiceFactory.prepareHmsComponentUpgradePluginAnnotatedClassesList(serverBoardBasePackage);
    ...
    public void prepareBoardServiceMap()
    {
        ...
        for ( Class boardServiceClass : boardServiceImplementationClasses )
        {
            try
            {
                IBoardService boardService = (IBoardService) boardServiceClass.newInstance();
                List<BoardInfo> boardInfos = boardService.getSupportedBoard();
                if ( boardInfos != null )
                {
    ...
    /**
     * Prepare key=[boardManufacturer]-[boardModel]-[hypervisorName]-[hypervisorProvider] for the board
     * 
     * @param boardInfo
     * @return
     */
    ...
    /**
     * Returns the HmsComponentUpgradeClass based on key provided
     * 
     * @param key
     * @return
     */
