...
public enum UpgradeStatusCode
{
    ...
    /** The hms oob upgrade success. */
    HMS_OOB_UPGRADE_SUCCESS( "HMS Out-of-band agent upgrade succeeded." ),

    /** The hms oob upgrade fail. */
    HMS_OOB_UPGRADE_FAILED( "HMS Out-of-band agent upgrade failed." ),

    /** The hms oob backup failed. */
    HMS_OOB_BACKUP_FAILED( "HMS Out-of-band agent backup failed." ),

    /** The hms oob rollback failed. */
    HMS_OOB_ROLLBACK_FAILED( "HMS Out-of-band agent rollback failed." ),

    /** The hms oob rollback failed. */
    HMS_OOB_ROLLBACK_SUCCESS( "HMS Out-of-band agent rollback succeeded." ),

    /** The hms oob upgrade invalid request. */
    HMS_OOB_UPGRADE_INVALID_REQUEST( "Invalid request to initiate HMS Out-of-band agent upgrade." ),

    /** The hms oob upgrade forbidden. */
    HMS_OOB_UPGRADE_FORBIDDEN( "HMS Out-of-band agent upgrade forbidden." ),

    /** The hms oob upgrade internal error. */
    ...
    HMS_UPGRADE_INITIATED( "HMS upgrade initiated." ),

    /** The hms upgrade script invalid arguments. */
    ...
    HMS_UPGRADE_SCRIPT_VALIDATION_FAILED( "HMS upgrade script validation failed." ),

    /** The hms upgrade success. */
    HMS_UPGRADE_SUCCESS( "HMS upgrade succeeded." ),

    /** The hms upgrade fail. */
    HMS_UPGRADE_FAILED( "HMS upgrade failed." ),

    /** The hms upgrade fail. */
    HMS_UPGRADE_FAILED_RESTART_REQUIRED( "HMS upgrade failed. HMS to be restarted manually." ),

    /** The hms backup failed. */
    HMS_BACKUP_FAILED( "HMS backup failed." ),

    /** The hms rollback failed. */
    HMS_ROLLBACK_FAILED( "HMS rollback failed." ),

    /** The hms rollback failed. */
    HMS_ROLLBACK_SUCCESS( "HMS rollback succeeded." ),

    /** The hms upgrade invalid request. */
    HMS_UPGRADE_INVALID_REQUEST( "Invalid request to initiate HMS upgrade." ),

    /** The hms upgrade forbidden. */
    HMS_UPGRADE_FORBIDDEN( "HMS upgrade forbidden." ),

    /** The hms upgrade internal error. */
