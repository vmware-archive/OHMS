...
public class SwitchBgpConfig
{
    ...
    private List<SwitchNetworkPrefix> exportedNetworks;
     ...
     */
    public List<SwitchNetworkPrefix> getExportedNetworks()
    {
     ...
     */
    public void setExportedNetworks( List<SwitchNetworkPrefix> exportedNetworks )
    {
