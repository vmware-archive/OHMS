    ...
    extends IpmiTask
{
    ...
    public PowerResetServerTask( TaskResponse response )
    {
        ...
        throws Exception
    {
        try
        {
            ...
            {
                Object[] paramsArray = new Object[] { serviceServerNode, PowerOperationAction.HARDRESET };
        ...
        {
            logger.error( "Error while triggering Power Reset Server for Node:" + node.getNodeID(), e );
            throw new HmsException( "Error while triggering Power Reset Server for Node:" + node.getNodeID(), e );
        }
    }
}
