    ...
    extends IpmiTask
{
        ...
        throws Exception
    {
        try
        {
            ...
            {
                // boolean status =
                // boardService.coldResetServer(serviceServerNode);
                // Object[] paramsArray = new Object[] { serviceServerNode,
                // PowerOperationAction.COLDRESET };
                boolean status = boardService.powerOperations( serviceServerNode, PowerOperationAction.COLDRESET );
                // boolean status =
